...
int compute011(int adjacents) {
    int temp_product = 1;

    // horizontal product
    int horizontal_product = 1;
    for (int i = 0; i < 20; i++) {
        for (int j = 0; j <= 20 - adjacents; j++) {
            for (int k = j; k <= j + adjacents - 1; k++)
    ...
    temp_product = 1;
    for (int i = 0; i <= 20 - adjacents; i++) {
        for (int j = 0; j <= 20 - adjacents; j++) {
            for (int k = 0; k <= adjacents - 1; k++)
    ...
    temp_product = 1;
    for (int i = 20 - 1; i >= adjacents - 1; i--) {
        for (int j = 0; j <= 20 - adjacents; j++) {
            for (int k = 0; k <= adjacents - 1; k++)
                temp_product *= array[i - k][j + k];
